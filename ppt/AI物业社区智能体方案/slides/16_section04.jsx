<Slide style={{ width: '1280px', height: '720px', background: 'linear-gradient(135deg, #172133 0%, #22395E 100%)', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 96px' }}>
